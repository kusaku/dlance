...
class Events_mdl extends Model
{
	...
	function get($user_id = '', $status = '')//¬ывод новых событий пользовател€
	{
	...
	function get_all($start_from = FALSE, $per_page, $user_id = '', $status = '')//¬ывод событий пользовател€
	{
		$this->db->order_by('date', 'desc');
	...
	function count_new_events($user_id = '')//Ќовые событи€ у пользовател€ дл€ вывода на главной
	{
		$this->db->where('user_id', $user_id);
