...
class Admin_mdl extends Model
{
	...
	function get_list($table)//��� ������� � ������ ����� � �������� - services
	{
		$this->db->select('*');
	...
	function check_current_password($password)//��������� ip, ��� ������ �� ��������� ������
	{
		$password = $this->hash_password_db($password);
	...
	function check_password($password)//��������� ip, ��� ������ �� ��������� ������
	{
		$this->db->select('password');
	...
	/*
	 ...
	 |---------------------------------------------------------------
	 */
	function get_designs_categories()//��� ������� � ������ ����� � �������� - services
	{
	...
	function get_purchased($start_from = FALSE, $per_page, $input = '')//����������� �����
	{
		...
		for($i = 0; $i < $count; $i++)
		{
			...
			switch($query[$i]['kind'])
			{
				case 1: $query[$i]['kind']  = '�������'; break;
				case 2: $query[$i]['kind']  = '�����'; break;
			}
		}
