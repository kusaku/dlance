...
/*
|---------------------------------------------------------------
|  аталог, и есть услуги пользователей
|---------------------------------------------------------------
*/
	function get($id)
	{
	...
	function get_categories()//ƒл€ списков и вывода услуг в аккаунта - services
	{
...
*/
	function get_categories_for_users()// атегории с колличеством пользователей предоставл€ющих данную услугу
	{
	...
	function users_descr($id)//ќписание дл€ пользователей каталога
	{
	...
	function cat_array($id)
	{
		...
		if( $parent_id != 0 )//≈сли выбранна€ категори€ не €вл€етс€ разделом - выводим проекты только с одной субкатегории
		{
			$array = array($id);
		...
		$this->db->where('parent_id', $id);//¬ыводим все подразделы главного раздела
