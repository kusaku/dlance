...
*/
    function rating() 
	{
		...
		$data = array (
			...
			'plus_balance' => $this->input->post('plus_balance'),
			'minus_balance' => $this->input->post('minus_balance'),
			'sell_design' => $this->input->post('sell_design'),
			'buy_design' => $this->input->post('buy_design'),
			'add_positive_review' => $this->input->post('add_positive_review'),
			'add_negative_review' => $this->input->post('add_negative_review'),
