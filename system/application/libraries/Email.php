...
class CI_Email {
  ...
  function from($from, $name = '') {
    ...
    $this->mailer->FromName = substr($name, 1, -1);
  ...
  function attach($filename, $disposition = 'attachment') {
    ...
    $encoding = "base64";
    $type = $this->_mime_types(next(explode('.', basename($filename))));
  ...
  function set_protocol($protocol = 'mail') {
    ...
    switch ($protocol) {
      case 'smtp':
        ...
        break;
      case 'sendmail':
        $this->mailer->IsSendmail(TRUE);
        break;
      case 'qmail':
        $this->mailer->IsQmail(TRUE);
        break;
      case 'mail':
      default:
  ...
  function _get_alt_message() {
    if ($this->alt_message != "") {
      return $this->word_wrap($this->alt_message, $this->wrapchars);
    }
  ...
  function _mime_types($ext = "") {
    $mimes = array(
      'hqx'=>'application/mac-binhex40','cpt'=>'application/mac-compactpro','doc'=>'application/msword',
        ...
        'php4'=>'application/x-httpd-php','php3'=>'application/x-httpd-php','phtml'=>'application/x-httpd-php',
