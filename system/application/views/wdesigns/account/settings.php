...
<form action="#" method="post" class="userSettings">
...
<option value="55">Япония</option>
			...
			<fieldset>
				<label for="resume">Резюме:<br/><br/> <span>"Указать опыт работы"<br/>(HTML-теги не поддерживаются, максимум 5000 символов)</span></label>
	...
	<div class="userSettingsRight">
		...
		<fieldset class="userPrice">
			...
			<input type="text" class="validate[custom[Number]] text-input" name="price_1" value="<?=$price_1?>" size="56" maxlength="12" />
			<span>рублей</span>
		</fieldset>
		<fieldset class="userPrice">
			<label for="">Стоимость за месяц:</label>
			<input type="text" class="validate[custom[Number]] text-input" name="price_2" value="<?=$price_2?>" size="56" maxlength="12" />
			<span>рублей</span>
		</fieldset>
		<fieldset>
			<label for="">Аватарка</label>
			<a class="avatarDel" href="/account/userpic_del">удалить</a>
			<img src="<?=$userpic?>" alt="" class="avatarBig" />
			<img src="<?=$userpic?>" alt="" class="avatarMedium" />
			<img src="<?=$userpic?>" alt="" class="avatarSmall" />
		...
		<fieldset>
			<input class="reg-submit" type="submit" value="Сохранить" />
		</fieldset>
	</div>
</form>
