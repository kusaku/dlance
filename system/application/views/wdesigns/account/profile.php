...
<div class="bbd">
<p class="subtitle"><b>Персональные данные</b></p>
<table class="profile">
<tr>
...
<td>Пол:</td>
<td>
<input type="radio" name="sex" value="1"<? if( $sex == 1 ): ?> checked="checked"<? endif; ?> />Мужской
<input type="radio" name="sex" value="2"<? if( $sex == 2 ): ?> checked="checked"<? endif; ?> />Женский
</td>
</tr>
...
<div class="bbd">
<p class="subtitle"><b>Дополнительная информация</b></p>
<table class="profile">
...
<tr>
<td class="caption resume">Резюме:<br>"Указать опыт работы"<br>

(HTML-теги не поддерживаются, максимум 5000 символов)</td>
