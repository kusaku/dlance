					...
					<div style="overflow:hidden;">
						<table class="order-form">
							<tr>
								...
								<td>
									<input type="radio" name="type" value="1" checked="checked" />Прямой платеж&nbsp &nbsp<input type="radio" name="type" value="2" /> С протекцией 
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="recipient" value="<?=set_value('recipient')?>" size="15" maxlength="15" />
								</td>
							</tr>
							<tr>
								<td class="caption">Сумма:</td>
								<td>
									<input type="text" name="amount" value="<?=set_value('amount')?>" size="6" maxlength="6" />рублей
								</td>
							</tr>
							<tr>
