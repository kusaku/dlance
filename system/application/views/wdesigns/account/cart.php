...
<table class="portfolio">
	...
	<tr>
		...
		<td class="options" colspan="2"><? if( $row['status_id'] == 1 ): ?> <input
			name="designs[]" type="checkbox" value="<?=$row['id']?>"
			checked="checked" /> <? endif; ?> <span class="fr"> <a
			href="/account/cart_del/<?=$row['id']?>">�������</a> </span></td>
	</tr>
	<? endforeach; ?>
</table>
