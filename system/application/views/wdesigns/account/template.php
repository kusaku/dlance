...
<script type="text/javascript" src="/templates/admin/js/old-browsers.js"></script>
...
<!-- Sub nav -->
<div id="sub-nav">
<div class="container_12"><a href="#" title="Help" class="nav-button"><b>Help</b></a>

<form id="search-form" name="search-form" method="post"
	action="search.html"><input type="text" name="s" id="s" value=""
	title="Search admin..." autocomplete="off"></form>
...
<ul id="status-infos">
	...
	<li><a href="#" class="button" title="5 "><img
		src="/templates/admin/images/icons/fugue/mail.png" width="16"
		height="16"> <strong>5</strong></a>
	...
	<ul class="small-files-list icon-mail">
		...
		<li><a href="#"><strong>Yest.</strong> Hi<br>
	...
	<ul class="small-files-list icon-comment">
		...
		<li><a href="#"><strong>Sebastien</strong>: This sure rocks!<br>
	...
	<p id="comments-info" class="result-info"><a href="#">Manage comments
	&raquo;</a></p>
	</div>
	</li>
	<li><a href="login.html" class="button red" title=""><span
...
<div class="float-left"><a href="#" class="button"></a> <a href="#"
	class="button"> </a></div>

<div class="float-right"><a href="#top" class="button"><img
	src="images/icons/fugue/navigation-090.png" width="16" height="16"> </a>
</div>
