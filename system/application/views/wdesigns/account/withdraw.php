					...
					<div>
						<div id="msearch">
							<form action="" method="post">
								...
								Сумма:
								<div>
									<input id="amount" name="amount" maxlength="6" type="text" onkeyup="commission()"/>
								</div>
								<div>
									Вывод: <b id="result">0</b>
									рублей
								</div>
								<div>
									Комиссия: <b id="commission">0</b>
									рублей
								</div>
								<div>
									<input value="Отправить" type="submit"></div>
							</form>
						</div>
					</div>
				</div>
