				...
				<div class="freshDesigns">
					...
					<!-- ?=show_highslide()? -->
						...
						<li>
							...
							<a href="<?=$row['full_image']?>" class="zoom grey" title="<?=$row['title']?>"><img src="<?php if (!empty($row['smallbw_image'])) {echo $row['smallbw_image'];} else {echo $row['small_image'];} ?>" alt="<?=$row['title']?>"/></a>
							<div class="moreInfo">
