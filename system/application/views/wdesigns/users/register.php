<div class="registrationForm">
	...
	<div id="authform">
		<form action="" method="post">
			<fieldset>
				<label for="username">
					Имя пользователя <span class="alert">*</span>
				</label>
				<br/>
			...
			<fieldset>
				<label for="email">
					Ваш email: <span class="alert">*</span>
				</label>
				<br/>
			...
			<fieldset>
				...
				<label for="password2">
					Повтор пароля <span class="alert">*</span>
				</label>
				<br/>
			...
			<fieldset>
				<label for="surname">
					День рождения <span class="alert">*</span>
				</label>
				<br/>
				<select name="dob_day">
					<option value="">---</option>
			...
			<br/>
			<h3>Дополнительно</h3>
			<label for="ruserlastname">
				Введите код <span class="alert">*</span>
			</label>
			<br/>
			<div class="answer">
				<?= $imgcode?>
			...
			<p>
				<span class="niceCheck"><input type="checkbox" class="validate[required] checkbox" name="agree" /></span>Принимаю условия <a href="/pages/agreement.html" target="_blank">пользовательского соглашения</a>
			</p>
			<fieldset>
