          ...
          <div>
            ...
            <ul class="clearfix">
              <li class="line">
                ...
                <input type="text" class="validate[required,custom[username],length[3,15]] text-input" name="username" value="<?=set_value('username')?>" size="24" maxlength="15" /></li>
              <li class="hint">от A-z и цифр 0-9.<br>Максимальное количество символов 15.<br>Минимальное количество символов 3.<br></li>
              <li class="line">
                <label for="email">Ваш email: *</label>
                <input type="text" class="validate[required,custom[email]] text-input" name="email" value="<?=set_value('email')?>" size="24" maxlength="48" /></li>
              <li class="hint">Третьи лица не имеют доступ к этой информации.</li>
              <li class="line psswrd">
                <label for="password1">Пароль *</label>
                <input type="password" class="validate[required,length[6,24]] text-input" name="password1" id="password1" size="24" maxlength="24" /></li>
              <li class="line psswrd">
                <label for="password2">Повтор пароля *</label>
                <input type="password" class="validate[required,confirm[password1]] text-input" name="password2" size="24" maxlength="24" /></li>
              <li class="hint" style="clear:left;">Минимальное количество символов 6. Максимальное количество символов 24.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div>
        <div>
          <div>
            ...
            <ul class="clearfix">
              <li class="hint">Публикуются на Вашей странице в сервисе. Необходимо указывать только достоверную информацию.</li>
              <li class="line fullname">
                <label for="surname">Фамилия *</label>
                <input type="text" class="validate[required,custom[onlyLetter],length[1,24]] text-input" name="surname" value="<?=set_value('surname')?>" size="24" maxlength="24" /></li>
              <li class="line fullname">
                <label for="name">Имя *</label>
                <input type="text" class="validate[required,custom[onlyLetter],length[1,24]] text-input" name="name" value="<?=set_value('name')?>" size="24" maxlength="24" /></li>
              <li class="hint" style="clear:left;">Полное имя на русском языке.</li>
              <li class="clear"></li> 
              <li class="line sex">
<label for="name">Пол *</label>
                  <label>
                    <input type="radio" name="sex" value="1" checked="checked" <?=set_checkbox('sex', '1'); ?>/>
                    Мужской</label>
                  <label>
                    <input type="radio" name="sex" value="2"<?=set_checkbox('sex', '2'); ?>/>
                    Женский</label>
              </li>
              <li class="clear"></li>
...
<option value=""></option>
              ...
              <li class="line">
                <label for="surname">День рождения *</label>
<select name="dob_day">
<option value="">---</option>
      ...
      <div>
        <div>
          <div>
            ...
            <ul class="clearfix">
              <li class="line">
                <label for="ruserlastname">Введите код *</label>
                <div class="answer"><?=$imgcode?></div>
                <input class="validate[required]" name="code" type="text" size="10" maxlength="10" /></li>
              <li class="hint">Пожалуйста, введите указанные символы.</li>
              <li class="line"><input type="checkbox" class="validate[required] checkbox" name="agree" /> Принимаю условия <a href="/pages/agreement.html" target="_blank">пользовательского соглашения</a></li>
            </ul>
          </div>
        </div>
      </div>
