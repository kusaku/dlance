<?=validation_errors()?>
<h1 class="title">Форма редактирования записей</h1>
<p class="subtitle">Редактировать запись</p>
        ...
        <div style="overflow:hidden;">
          <table class="order-form">
            <tr>
              ...
              <td class="frnt"><input type="text" class="text" name="title" value="<?=$title?>" size="64" maxlength="128" /></td>
            </tr>
