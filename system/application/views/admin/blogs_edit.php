...
<form action="" method="post">
			<div id="content" class="container_16 clearfix">
				<div class="grid_16">
					...
					<p class="error">Форма редактирования записей.</p>
				</div>

				<div class="grid_8">
					<p>
						<label for="title">Заголовок <small>Максимальное количество символов 64.</small></label>
						<input type="text" name="title" maxlength="64" value="<?=$title?>">
					</p>
				</div>

				<div class="grid_8">
					<p>
						<label for="title">Категория <small>Выберите категорию.</small></label>
