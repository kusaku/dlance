			...
			<div class="block-content">
				...
				<form class="form" id="tab-stats" method="post" action="">
					...
					<div id="chart_div" style="height:330px; margin-top:20px;">
						...
						<p>
							Средств пополнено: <strong>
								<?= $addition?>
								рублей</strong>
						</p>
						<p>
							Средств выведено: <strong>
								<?= $output?>
								рублей</strong>
						</p>
						<hr/>
						<p>
							Сумма средств на счетах всех Пользователей: <strong>
								<?= $resources?>
								рублей</strong>
						</p>
						<p>
							Общая сумма готовых к выводу средств: <strong>
								<?= $resources_2?>
								рублей</strong>
						</p>
					</div>
				...
				<ul class="message no-margin">
					<li>
						<strong>Развёрнутая статистика сервиса</strong>
					</li>
				</ul>
			</div>
		</div>
