...
<a href="/administrator/info/?range=<?=$day?>+-+<?=$today?>">�����</a> |
<a href="/administrator/info/?range=<?=$today?>+-+<?=$today?>">�������</a>
| <a href="/administrator/info/?range=<?=$week?>+-+<?=$today?>">������</a>
| <a href="/administrator/info/?range=<?=$month?>+-+<?=$today?>">�����</a>
| <a href="/administrator/info/?range=<?=$year?>+-+<?=$today?>">���</a>
| <a href="/administrator/info/">�� ���� ������</a>
...
<p>������� ��������: <strong><?=$designs_purchased?></strong></p>
