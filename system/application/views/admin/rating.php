	...
	<div id="content" class="container_16 clearfix">
		...
		<div class="grid_3">
			<p>
				...
				<input type="text" name="auth" maxlength="16" value="<?=$auth?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Отправка сообщения</label>
				<input type="text" name="send_message" maxlength="16" value="<?=$send_message?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Получение сообщения</label>
				<input type="text" name="receipt_message" maxlength="16" value="<?=$receipt_message?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Увеличение баланса</label>
				<input type="text" name="plus_balance" maxlength="16" value="<?=$plus_balance?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Уменьшение баланса</label>
				<input type="text" name="minus_balance" maxlength="16" value="<?=$minus_balance?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Продажа дизайна</label>
				<input type="text" name="sell_design" maxlength="16" value="<?=$sell_design?>"></p>
		</div>
		<div class="grid_3">
			<p>
		...
		<div class="grid_3">
			<p>
				...
				<input type="text" name="add_positive_review" maxlength="16" value="<?=$add_positive_review?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Отправка отзыва(-)</label>
				<input type="text" name="add_negative_review" maxlength="16" value="<?=$add_negative_review?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Получение отзыва(+)</label>
				<input type="text" name="receipt_positive_review" maxlength="16" value="<?=$receipt_positive_review?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Получение отзыва(-)</label>
				<input type="text" name="receipt_negative_review" maxlength="16" value="<?=$receipt_negative_review?>"></p>
		</div>
		<div class="grid_3">
			<p>
				<label for="title">Добавление дизайна</label>
				<input type="text" name="add_design" maxlength="16" value="<?=$add_design?>"></p>
		</div>
		<div class="grid_16">
			<p class="submit">
