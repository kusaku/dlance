...
<html lang="en">
	<head>
		...
		<!-- Comment/uncomment one of these files to toggle between fixed and fluid layout --><!--<link href="css/960.gs.css" rel="stylesheet" type="text/css">-->
	...
	<body>
		...
		<!-- End main nav --><!-- Sub nav -->
		<div id="sub-nav">
			<div class="container_12"></div>
		</div>
		<!-- End sub nav --><!-- Status bar -->
		<div id="status-bar">
			<div class="container_12">
				<ul id="status-infos">
					<!--
					...
					<li>
						<a href="/administrator/logout" class="button red" title="ВЫХОД"><span class="smaller">ВЫХОД</span></a>
					</li>
				</ul>
				<ul id="breadcrumb">
					<li>
						<a href="/administrator/" title="Главная">Главная</a>
					</li>
					<li>
		...
		<!-- End header --><!-- Always visible control bar --><!-- End control bar -->
		<?= $content?>
		<footer>
			<div class="float-left">
				<a href="/" class="button" target="_new">Перейти на сайт</a>
			</div>
			<div class="float-right">
				<a href="#top" class="button"><img src="/templates/admin/images/icons/fugue/navigation-090.png" width="16" height="16">Перейти в самый верх</a>
			</div>
		</footer><!--[if lt IE 8]></div><![endif]-->
