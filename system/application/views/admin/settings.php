...
<option value="1"<? if( $moder == 1 ): ?> selected="selected"<? endif; ?>>Включена</option>
				...
				<div class="grid_8">
					<p>
						<label>Логин <small>Логин мерчанта</small></label>
						<input name="pay_robox_login" value="<?=$pay_robox_login?>" />
					</p>
				</div>
				<div class="grid_8">
					<p>
						<label>Режим <small>Режим взаимодействия с сервером</small></label>
				...
				<div class="grid_8">
					<p>
						<label>Пароль 1 <small>Пароль мерчанта №1</small></label>
						<input name="pay_robox_pass1" value="<?=$pay_robox_pass1?>" />
					</p>
				</div>
				<div class="grid_8">
					<p>
						<label>Пароль 2 <small>Пароль мерчанта №2</small></label>
				...
				<div class="grid_5">
					<p>
						<label>ID <small>ID-номер партнера</small></label>
						<input name="pay_qiwi_id" value="<?=$pay_qiwi_id?>" />
					</p>
				</div>
				<div class="grid_5">
					<p>
						<label>LifeTime <small>Время жизни счета в часах</small></label>
						<input name="pay_qiwi_lt" value="<?=$pay_qiwi_lt?>" />
					</p>
				</div>
				<div class="grid_6">
					<p>
						<label>Только агенты <small>Проверка на наличие кошелька</small></label>
				...
				<div class="grid_16">
					<p>
						<label>Кошелек <small>Номер кошелька для приема оплаты</small></label>
