...
<a href="/administrator/purchased/?range=<?=$day?>+-+<?=$today?>">�����</a>
| <a href="/administrator/purchased/?range=<?=$today?>+-+<?=$today?>">�������</a>
| <a href="/administrator/purchased/?range=<?=$week?>+-+<?=$today?>">������</a>
| <a href="/administrator/purchased/?range=<?=$month?>+-+<?=$today?>">�����</a>
| <a href="/administrator/purchased/?range=<?=$year?>+-+<?=$today?>">���</a>
| <a href="/administrator/purchased/">�� ���� ������</a>
