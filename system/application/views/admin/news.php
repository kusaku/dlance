...
<form class="block-content form" id="table_form" method="post"
	action="/administrator/news_del">
<h1>������� <a href="/administrator/news_add/"><img
...
<table class="table" cellspacing="0" width="100%">
	...
	<thead>
		<tr>
			...
			<th scope="col">���������</th>
			<th scope="col"><span class="column-sort"> <a href="#"
				title="Sort up" class="sort-up"></a> <a href="#" title="Sort down"
				class="sort-down"></a> </span> ����</th>
	...
	<? foreach($data as $row): ?>
		<tr>
			<th scope="row" class="table-check-cell"><input type="checkbox"
				name="news[]" value="<?=$row['id']?>" /></th>
			<td><?=$row['title']?></td>
			<td><?=$row['date']?></td>
			<td class="table-actions"><a
				href="/administrator/news_edit/<?=$row['id']?>"
