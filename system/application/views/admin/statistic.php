...
<a href="/administrator/statistic/?range=<?=$day?>+-+<?=$today?>">вчера</a> | 
<a href="/administrator/statistic/?range=<?=$today?>+-+<?=$today?>">сегодня</a> | 
<a href="/administrator/statistic/?range=<?=$week?>+-+<?=$today?>">неделя</a> | 
<a href="/administrator/statistic/?range=<?=$month?>+-+<?=$today?>">месяц</a> | 
<a href="/administrator/statistic/?range=<?=$year?>+-+<?=$today?>">год</a> | 
<a href="/administrator/statistic/">за весь период</a>
