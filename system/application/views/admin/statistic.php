...
<a href="/administrator/statistic/?range=<?=$day?>+-+<?=$today?>">�����</a>
| <a href="/administrator/statistic/?range=<?=$today?>+-+<?=$today?>">�������</a>
| <a href="/administrator/statistic/?range=<?=$week?>+-+<?=$today?>">������</a>
| <a href="/administrator/statistic/?range=<?=$month?>+-+<?=$today?>">�����</a>
| <a href="/administrator/statistic/?range=<?=$year?>+-+<?=$today?>">���</a>
| <a href="/administrator/statistic/">�� ���� ������</a>
