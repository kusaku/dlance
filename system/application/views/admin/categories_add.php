...
<form action="" method="post">
			<div id="content" class="container_16 clearfix">
				...
				<div class="grid_8">
					<p>
						<label for="title">Раздел <small>Выберите основной раздел.</small></label>
...
<? endforeach; ?>
				...
				<div class="grid_16">
					<p>
						...
						<input type="text" name="title" maxlength="255" value="<?=set_value('title')?>">
					</p>
				</div>

				<div class="grid_16">
					<p>
						<label>Ключевые слова <small>Максимальное количество символов 255.</small></label>
						<input type="text" name="keywords" maxlength="255" value="<?=set_value('keywords')?>">
					</p>
				</div>

				<div class="grid_16">
					<p>
						<label>Описание <small>Максимальное количество символов 255.</small></label>
				...
				<div class="grid_16">
					<p>
						<label>Описание для каталога пользователей <small>Максимальное количество символов 10000.</small></label>
