...
<article class="container_12">
	<section class="grid_12">
		<div class="block-border">
			<form class="block-content form" id="table_form" method="post" action="/administrator/tariffs_action">
				<h1>Тарифы<a href="/administrator/tariffs_add/"><img src="/templates/admin/images/icons/fugue/plus-circle-blue.png" width="16" height="16"> Добавить</a></h1>
						...
						<tbody>
							...
							<tr>
								<th scope="row" class="table-check-cell">
									<input type="checkbox" name="tariffs[]" value="<?=$row['id']?>" />
								</th>
								<td>
