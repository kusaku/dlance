	...
	<article class="container_12">
		...
		<section class="grid_12">
			<div class="block-border"><form class="block-content form" id="table_form" method="post" action="/administrator/applications">
				<h1>Заявки</h1>
...
<? if( $row['status_id'] == 1 ):?><a href="/administrator/applications_done/<?=$row['id']?>">Оплачена</a><? endif; ?>
							</td>
						</tr>
<? endforeach; ?>
					</tbody>
