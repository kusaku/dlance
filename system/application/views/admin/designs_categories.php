...
<form class="block-content form" id="table_form" method="post"
	action="/administrator/designs_categories_action">
<h1>��������� <a href="/administrator/designs_categories_add/"><img
	...
	<? if( $row['parent_id'] == 0 ): //�������?>
		<tr>
			...
			<td class="table-actions"><a
				href="/administrator/designs_categories_edit/<?=$row['id']?>"
		...
		<tr>
			...
			<td><?=$row2['name']?></td>
			<td class="table-actions"><a
				href="/administrator/designs_categories_edit/<?=$row2['id']?>"
				title="�������������" class="with-tip"><img
				src="/templates/admin/images/icons/fugue/pencil.png" width="16"
				height="16"></a></td>
		</tr>
