...
<!--[if lt IE 8]><div class="ie7"><![endif]-->
	...
	<nav id="main-nav">
		...
		<ul class="container_12">
			<li class="home<? if( $view == 'index' or $view == 'applications' or $view == 'mailer' ): ?> current<? endif; ?>"><a href="#" title="Главная">Главная</a>
				<ul>
...
<li<? if( $view == 'mailer' ): ?> class="current"<? endif; ?>><a href="/administrator/mailer/" title="Рассылка">Рассылка</a></li>
			...
			<li class="write<? if( $view == 'blogs' ): ?> current<? endif; ?>"><a href="#" title="Блоги">Блоги</a>
				<ul>
<li<? if( $view == 'blogs' ): ?> class="current"<? endif; ?>><a href="/administrator/blogs/" title="Записи">Записи</a></li>
				</ul>
			</li>
			<li class="write<? if( $view == 'pages' or $view == 'pages_add' ): ?> current<? endif; ?>"><a href="#" title="Страницы">Страницы</a>
				<ul>
...
<li<? if( $view == 'pages_add' ): ?> class="current"<? endif; ?>><a href="/administrator/pages_add/" title="Добавить">Добавить</a></li>
			...
			<li class="write<? if( $view == 'help_pages' or $view == 'help_pages_add' or $view == 'help_categories' or $view == 'help_categories_add' ): ?> current<? endif; ?>"><a href="#" title="Помощь">Помощь</a>
				<ul>
...
<li<? if( $view == 'help_categories_add' ): ?> class="current"<? endif; ?>><a href="/administrator/help_categories_add/" title="Добавить категорию">Добавить категорию</a></li>
			...
			<li class="write<? if( $view == 'news' or $view == 'news_add' ): ?> current<? endif; ?>"><a href="#" title="Новости">Новости</a>
				<ul>
...
<li<? if( $view == 'news_add' ): ?> class="current"<? endif; ?>><a href="/administrator/news_add/" title="Добавить">Добавить</a></li>
			...
			<li class="write<? if( $view == 'reports' ): ?> current<? endif; ?>"><a href="#" title="Жалобы">Жалобы</a>
				<ul>
<li<? if( $view == 'reports' ): ?> class="current"<? endif; ?>><a href="/administrator/reports/" title="Список">Список</a></li>
				</ul>
			</li>
			<li class="comments<? if( $view == 'categories' or $view == 'categories_add' ): ?> current<? endif; ?>"><a href="#" title="Категории">Категории</a>
				<ul>
...
<li<? if( $view == 'categories_add' ): ?> class="current"<? endif; ?>><a href="/administrator/categories_add/" title="Добавить">Добавить</a></li>
			...
			<li class="medias<? if( $view == 'designs' or $view == 'designs_categories' or $view == 'designs_categories_add' ): ?> current<? endif; ?>"><a href="#" title="Дизайны">Дизайны</a>
				<ul>
...
<li<? if( $view == 'designs_categories_add' ): ?> class="current"<? endif; ?>><a href="/administrator/designs_categories_add/" title="Добавить категорию">Добавить категорию</a></li>
			...
			<li class="users<? if( $view == 'users' or $view == 'tariffs' or $view == 'tariffs_add' ): ?> current<? endif; ?>"><a href="#" title="Пользователи">Пользователи</a>
				<ul>
...
<li<? if( $view == 'tariffs_add' ): ?> class="current"<? endif; ?>><a href="/administrator/tariffs_add/" title="Добавить тариф">Добавить тариф</a></li>
			...
			<li class="stats<? if( $view == 'transaction' ): ?> current<? endif; ?>"><a href="#" title="Статистика">Статистика</a>
				<ul>
<li<? if( $view == 'transaction' ): ?> class="current"<? endif; ?>><a href="/administrator/transaction/" title="История операций">История операций</a></li>
				</ul>
			</li>
			<li class="settings<? if( $view == 'settings' or $view == 'rating' or $view == 'profile' ): ?> current<? endif; ?>"><a href="#" title="Настройки">Настройки</a>
				<ul>
