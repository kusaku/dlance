...
<p><label for="title">��������� � �����</label> <input type="text"
	name="price_of_month" maxlength="16" value="<?=$price_of_month?>"></p>
</div>

<div class="grid_4">
<p><label for="title">��������� � ���</label> <input type="text"
	name="price_of_year" maxlength="16" value="<?=$price_of_year?>"></p>
</div>

<div class="grid_4">
<p><label for="title">��������</label> <input type="text"
	name="commission" maxlength="16" value="<?=$commission?>"></p>
</div>

<div class="grid_4">
<p><label for="title">����������� �����</label> <input type="text"
	name="minimum_w_a" maxlength="16" value="<?=$minimum_w_a?>"></p>
</div>
