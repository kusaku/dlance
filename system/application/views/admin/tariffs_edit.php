			...
			<div id="content" class="container_16 clearfix">
				...
				<div class="grid_16">
					<p>
						...
						<input type="text" name="name" maxlength="16" value="<?=$name?>">
					</p>
				</div>
				...
				<div class="grid_4">
					<p>
						...
						<input type="text" name="price_of_month" maxlength="16" value="<?=$price_of_month?>">
					</p>
				</div>
				...
				<div class="grid_4">
					<p>
						...
						<input type="text" name="price_of_year" maxlength="16" value="<?=$price_of_year?>">
					</p>
				</div>
				...
				<div class="grid_4">
					<p>
						...
						<input type="text" name="commission" maxlength="16" value="<?=$commission?>">
					</p>
				</div>
				...
				<div class="grid_4">
					<p>
						...
						<input type="text" name="minimum_w_a" maxlength="16" value="<?=$minimum_w_a?>">
					</p>
				</div>
