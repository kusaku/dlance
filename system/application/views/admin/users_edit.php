...
<form action="" method="post">
			<div id="content" class="container_16 clearfix">
				...
				<div class="grid_8">
					<p>
						<label for="title">Фамилия <small>Максимальное количество символов 24.</small></label>
						<input type="text" name="surname" maxlength="24" value="<?=$surname?>">
					</p>
				</div>

				<div class="grid_8">
					<p>
						<label for="title">Имя <small>Максимальное количество символов 24.</small></label>
...
<option value="<?=$row['id']?>"<? if( $team == $row['id'] ):?> selected="selected"<? endif; ?>><?=$row['name']?></option>
<? endforeach; ?>
</select>
					</p>
				</div>
				...
				<div class="grid_16">
					<p>
						<label>Забанить <small>Введите причину бана.</small></label>
				...
				<div class="grid_16">
					<p>
						<label>Резюме <small>Максимальное количество символов 10000.</small></label>
